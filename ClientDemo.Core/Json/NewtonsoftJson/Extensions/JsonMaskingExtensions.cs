...
namespace ClientDemo.Core.Json.NewtonsoftJson.Extensions
{
	/// <summary>
	/// Json Masking Extension
	/// Daha fazla bilgi için https://github.com/ThiagoBarradas/jsonmasking
	/// </summary>
	public static class JsonMasking
	{
		...
		/// <returns></returns>
		public static string MaskFields(this string json, List<string> blacklist, string mask)
		{
			...
			var jsonObject = (JToken)JsonConvert.DeserializeObject(json);
